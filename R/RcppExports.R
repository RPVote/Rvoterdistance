...
cpp_dist_to_boundary <- function(voter_lat, voter_lon, seg_start_lat, seg_start_lon, seg_end_lat, seg_end_lon, show_progress) {
    .Call(`_Rvoterdistance_cpp_dist_to_boundary`, voter_lat, voter_lon, seg_start_lat, seg_start_lon, seg_end_lat, seg_end_lon, show_progress)
}
